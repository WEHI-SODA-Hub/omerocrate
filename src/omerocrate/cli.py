...
def upload(
    ...
    uploader_path: Annotated[str, typer.Option("--uploader-path", "-u", help="Module path to the OmeroUploader class")] = "omerocrate.ApiUploader",
    seg_uploader_path: Annotated[str, typer.Option("--seg-uploader-path", "-s", help="Module path to the SegmentationUploader class")] = "omerocrate.SegmentationUploader",
